  ...
  foreach(package ${optional_dependent_packages})
    if(${package}_FOUND)
      if(NOT DART_SKIP_${package})
        ...
        list(APPEND target_compile_definitions_public -DDART_HAVE_${package}=0)
        message(STATUS "Building sub component [${sub_component_name}] without [${package}] because [DART_SKIP_${package}] is set")
      endif()
    else()
      list(APPEND target_compile_definitions_public -DDART_HAVE_${package}=0)
      message(STATUS "Building sub component [${sub_component_name}] without [${package}] because the package is not found")
    endif()
  endforeach()
