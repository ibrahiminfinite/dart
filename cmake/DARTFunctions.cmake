  ...
  foreach(package ${_ARG_DEPENDENT_PACKAGES_REQUIRED})
    if(${package}_FOUND)
      if(NOT DART_SKIP_${package})
        ...
        list(APPEND _ARG_TARGET_COMPILE_DEFINITIONS_PUBLIC -DDART_HAVE_${package}=0)
        message(STATUS "Building target [${current_target_name}] without sub component [${_ARG_SUB_COMPONENT_NAME}] because DART_SKIP_${package} is set")
        return()
      endif()
    else()
      list(APPEND _ARG_TARGET_COMPILE_DEFINITIONS_PUBLIC -DDART_HAVE_${package}=0)
      message(STATUS "Building target [${current_target_name}] without sub component [${_ARG_SUB_COMPONENT_NAME}] because of missing dependency package ${package}")
      return()
    endif()
  endforeach()
